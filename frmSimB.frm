VERSION 5.00
Begin VB.Form frmSimB 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Simulação Semáforo de  3 tempos"
   ClientHeight    =   4140
   ClientLeft      =   6675
   ClientTop       =   2010
   ClientWidth     =   4800
...
Private Sub tsemB_Timer()
    ...
    nodos(25).aberto = semD
    nodos(52).aberto = semC
    nodos(121).aberto = semB
    nodos(132).aberto = semA
